export default en = {
  ...
  certificate: {
    ...
    androidPermissionDenied: 'Storage Permission Denied',
  },
  ResultScreen: {
    correctOption: 'Correct Answer',
    wrongOption: 'Wrong Answer',
    chapter: 'Chapter',
    course: 'Course:',
    passingGrade: 'Passsing Grade',
    correct: 'Correct',
    wrong: 'Wrong',
    listOfQsn: 'List of Questions',
    qsn: 'Question',
  },
  overview: {
    previewTitle: 'Preview this course',
